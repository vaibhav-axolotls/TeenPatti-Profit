package com.axolotls.teenpattiprofit.SampleClasses;

public class Const {
//
    public static final String MAIN = "https://teenpattifestival.com/teenpattiprofit/";
...
//    public static final String BSE_URL2 = MAIN2+"api/";
    ...
    public static final String LOG_IN = BSE_URL+"User/login_with_pwd";

    public static final String email_login = BSE_URL+"User/email_login";
    public static final String SEND_OTP = BSE_URL+"User/send_otp";
    public static final String SEND_OTP1 = BSE_URL+"User/send_otp1";
