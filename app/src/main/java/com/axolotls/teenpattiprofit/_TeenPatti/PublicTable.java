package com.axolotls.teenpattiprofit._TeenPatti;
...
import com.axolotls.teenpattiprofit.Activity.BuyChipsList;
...
public class PublicTable extends BaseActivity {
...
//        SetBackgroundImageAsDisplaySize(this,rltParentLayout,R.drawable.bgnew1);
        Glide.with(this).load(R.drawable.new_red_table_bg).into(imgTable);
