package com.axolotls.teenpattiprofit.Fragments;
...
import com.axolotls.teenpattiprofit._Rummy.Rummy5Player;
import com.axolotls.teenpattiprofit._TeenPatti.PublicTable;
import com.axolotls.teenpattiprofit.model.TableModel;
    ...
    private void CALL_API_getTableList() {
        ...
        if(game_tag.equals(TEENPATTI)){
         URL = Const.get_table_master;
            Log.d("ActiveTables_BF","get_table_master");

        }else{
            URL = Const.RummygetTableMaster;
            Log.d("ActiveTables_BF","RummygetTableMaster");
        }
