...
import com.axolotls.teenpattiprofit.SampleClasses.CommonFunctions;
...
public class LoginScreen extends BaseActivity {
    ...
    EditText edtPhone,edtPhone1, edtname, edtReferalCode;
    TextView tv,forgotPass,textView3;
    int pStatus = 0;
    private Handler handler = new Handler();
    ImageView imglogin,imgSignup;
    AlertDialog dialog;
    EditText edit_OTP;
    ...
    ImageView imgBackground, imgBackgroundlogin,imgVerifyClose,imgSignUpClose;
    Context context = LoginScreen.this;
    public BottomSheetBehavior sheetBehavior;
    public View bottom_sheet;
    ScrollView lytLogin,lytVerify,lytSignUp;
    Button btnRegister;
    EditText edtName,edtEmail,edtPassword,edtPassword1;
...
//        edtEmail = findViewById(R.id.edtEmail);
        ...
        imgSignUpClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lytLogin.setVisibility(View.VISIBLE);
                lytSignUp.setVisibility(View.GONE);
                textView3.setVisibility(View.VISIBLE);
                textView3.setText("SIGN UP");

            }
        });

        imgVerifyClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lytLogin.setVisibility(View.VISIBLE);
        ...
        forgotPass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(),"Forgot Password Button Test",Toast.LENGTH_SHORT).show();
        ...
        imgSignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Toast.makeText(getApplicationContext(),"Login Button Test",Toast.LENGTH_SHORT).show();
...
//                        if (isSelected) {
                            ...
                            login( "");
//                        Toast.makeText(getApplicationContext(),"Login API Test",Toast.LENGTH_SHORT).show();
...
//                        if (isSelected) {
                        ...
                        loginWithPWD( "");
                        Toast.makeText(getApplicationContext(),"Login API Test1",Toast.LENGTH_SHORT).show();
...
//                    if(!txtreffer.getText().toString().trim().equals("Enter Reffer code"))
    ...
    private void loginWithPWD(final String value) {

        final ProgressDialog progressDialog = new ProgressDialog(LoginScreen.this);
        progressDialog.setCancelable(false);
        progressDialog.setMessage("Logging in..");
        progressDialog.show();
        String mypwd = edtPassword1.getText().toString();
        String myNum = edtPhone1.getText().toString();
        Log.d("Params","Params=="+mypwd+""+myNum);


        HashMap<String, String> params = new HashMap<String, String>();
        params.put("password", mypwd);
        params.put("mobile", myNum);

        Log.d("Params","Params=="+params);

        ApiRequest.Call_Api(context, Const.LOGIN, params, new Callback() {
            @Override
            public void Responce(String resp, String type, Bundle bundle) {

                progressDialog.dismiss();
                handleResponsePWD(resp, value);
            }
        });
...
//        }
    ...
    private void handleResponsePWD(String response, String value) {

        try {
            JSONObject jsonObject = new JSONObject(response);

            String code = jsonObject.getString("code");
            Log.d("login resp","login resp=="+response);
...
//                    Toast.makeText(getApplicationContext(),"Login OTP API Test",Toast.LENGTH_SHORT).show();
...
//                params.put("name", edtname.getText().toString());
                ...
                Log.d("register","register api params=="+params);
